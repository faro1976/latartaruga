...
-- -----------------------------------------------------
-- Table `SENSORYTURTLES`.`APPLICATION_LOG`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `SENSORYTURTLES`.`APPLICATION_LOG` ;

CREATE TABLE IF NOT EXISTS `SENSORYTURTLES`.`APPLICATION_LOG`  (
  `idAPPLICATIONLOG` INT NOT NULL AUTO_INCREMENT,
  `Therapist` VARCHAR(255) NOT NULL,
  `Member` VARCHAR(255) NOT NULL,
  `idROOM` INT NOT NULL,
  `idDEVICE` INT NOT NULL,
  `typeDEVICE` VARCHAR(10) NOT NULL,
  `cmdDEVICE` VARCHAR(1000) NOT NULL,
  `tsCMD` TIMESTAMP NOT NULL,
  PRIMARY KEY (`idAPPLICATIONLOG`),
  CONSTRAINT `FK_APPLICATION_LOG_ROOM`
    FOREIGN KEY (`idROOM`)
    REFERENCES `SENSORYTURTLES`.`ROOM` (`idROOM`)
    ON DELETE NO ACTION
